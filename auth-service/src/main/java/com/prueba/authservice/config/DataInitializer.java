package com.prueba.authservice.config;
...
import com.prueba.authservice.features.identity.repository.AuthoritiesRepository;
import com.prueba.authservice.features.identity.repository.RoleRepository;
...
import static com.prueba.authservice.features.identity.domain.RoleEnum.ADMIN;
import static com.prueba.authservice.features.identity.domain.RoleEnum.USER;
